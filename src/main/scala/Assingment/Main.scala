...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    case class Movies(imdb_title_id1: String, title1: String, year1: String, drct: String, cntry: List[String], lang: String, bdgt: String, durtn: String, usrRvws: String, votes: String) {
      ...
      for (line <- Source.fromFile(fileName).getLines) {
        if (movieIndex < 10000) {
          if (i == 0) {
            ...
            if (list2.size >= 20) {
              var movie = new Movies(list2(0), list2(1), list2(3), list2(9), countryList, list2(8), list2(16), list2(6), list2(20), list2(15))
